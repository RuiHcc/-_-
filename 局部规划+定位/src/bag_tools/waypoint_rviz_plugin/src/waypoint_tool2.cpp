...
{
  sub_ = nh_.subscribe<nav_msgs::Odometry> ("/ant02/state_estimation", 5, &WaypointTool2::odomHandler, this);
  pub_ = nh_.advertise<geometry_msgs::PointStamped>("/ant02/way_point", 5);
