...
int main(int argc, char** argv)
{
  ...
  ros::Publisher pubSpeed = nh.advertise<geometry_msgs::TwistStamped> ("cmd_vel_stamp", 5);
  ros::Publisher pubSpeed2 = nh.advertise<geometry_msgs::Twist> ("cmd_vel", 5);
  ...
  while (status) {
	...
	cmd_vel2 = cmd_vel.twist;
	pubSpeed2.publish(cmd_vel2);
